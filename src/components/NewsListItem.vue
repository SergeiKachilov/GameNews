...
<style scoped>
     ...
     .main-body__news-rating-container {
          width: 100%;
          display: flex;
          flex-direction: row;
          align-items: center;
     ...
     .main-body__news-comments-container {
          max-width: 7.3rem;
          width: 100%;
          height: 1.4rem;
          display: flex;
